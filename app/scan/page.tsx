        ...
        <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm space-y-3">
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-2 border border-gray-200 rounded-lg text-sm text-gray-800"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-2 border border-gray-200 rounded-lg font-bold text-base text-gray-800"
            />
          </div>

          <button
            onClick={handleSave}
            className="w-full bg-green-600 text-white font-semibold py-2.5 rounded-lg text-sm hover:bg-green-700 transition"
          >
            Simpan Transaksi
          </button>
        </div>
